    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black p-3 sm:p-8">
      ...
      <div className="max-w-xl sm:max-w-4xl mx-auto mb-4 sm:mb-6">
        <a 
          ...
          className="block bg-gray-900 rounded-xl shadow-2xl p-3 sm:p-4 text-gray-100 hover:bg-gray-800 transition-colors"
        >
          <div className="flex items-center justify-center gap-2 sm:gap-3">
            ...
            />
            <span className="text-sm sm:text-lg font-medium">Grupo de entrada free - Surebet</span>
          </div>
        </a>
      </div>
